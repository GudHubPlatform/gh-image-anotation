export function setupToolbar(editor, root) {
    ...
    root.querySelector('#upload-image-btn')?.addEventListener('change', (e) => editor.uploadImage(e));
    ...
    root.querySelector('#input-image')?.addEventListener('cancel', (e) => e.stopPropagation());
}
